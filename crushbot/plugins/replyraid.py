...
@CrushBot1.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@CrushBot2.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@CrushBot3.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@CrushBot4.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@CrushBot5.on(events.NewMessage(incoming=True, pattern='/replyraid'))
...
@CrushBot1.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@CrushBot2.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@CrushBot3.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@CrushBot4.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@CrushBot5.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
...
@CrushBot1.on(events.NewMessage(incoming=True))
@CrushBot2.on(events.NewMessage(incoming=True))
@CrushBot3.on(events.NewMessage(incoming=True))
@CrushBot4.on(events.NewMessage(incoming=True))
@CrushBot5.on(events.NewMessage(incoming=True))
async def fuck(e):
    global enemy
